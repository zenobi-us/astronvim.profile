...
return {
  {
    ...
    config = function()
      ...
      keymap(
        ...
        { desc = "Run all tests", noremap = true, silent = true }
      )
      keymap(
        "n",
        "<leader>ts",
        function() neotest.run.stop() end,
        { desc = "Stop test", noremap = true, silent = true }
      )
      keymap(
        "n",
        "<leader>td",
        function() neotest.run.run { strategy = "dap" } end,
        { desc = "Debug test", noremap = true, silent = true }
      )
      keymap(
        "n",
        "<leader>to",
      ...
      keymap(
        "n",
        "<leader>tn",
        function() neotest.jump.next() end,
        { desc = "Next test", noremap = true, silent = true }
      )
      keymap(
        "n",
        "<leader>tp",
        function() neotest.jump.prev() end,
        { desc = "Previous test", noremap = true, silent = true }
      )
    end,
  },
}
