...
- **Search & Navigation**: fzf-lua, Snacks.nvim, dashboard-logo.nvim — fuzzy finding, animated CRT-style startup dashboard with selectable logo assets, and command/keymap discovery
