...
- **Search & Navigation**: fzf-lua, Snacks.nvim, dashboard-logo.nvim — fuzzy finding, dashboard-scoped CRT logo animation, theme-derived colour palettes, terminal previews, selectable logo assets, and command/keymap discovery
